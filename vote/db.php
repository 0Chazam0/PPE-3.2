...
--------------------------------------------------------- */
	...
	require '../configs/param.php'; // get the db connection info
	...
	$query = Param::getInstance()->query("SELECT total_votes, total_value, used_ips FROM ratings WHERE page_id='$id_sent' ")or die(" Error: ".mysql_error());
