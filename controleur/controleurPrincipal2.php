...
require_once 'modele/DAO/insert.php';
require_once 'modele/DAO/update.php';
...
if (!isset($_SESSION['identite'])) {
	//echo "<a href='index.php?menuPrincipal=Noter'>";
	...
	if (isset($nomResto))
	{
		$menuPrincipal->ajouterComposant($menuPrincipal->ajouterImage('<a href="t">', '<img src="image\notif.png" width="5%" height="5%" alt="notif">', '</a>'));
		//$menuPrincipal->ajouterComposant($menuPrincipal->creerItemLien('Noter',"Noter"));
	}
